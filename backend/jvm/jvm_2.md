...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200906143336489.png" alt="image-20200906143336489" style="zoom:50%;" />
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200910135307560.png" alt="image-20200910135307560" style="zoom: 67%;" />
...
Java堆的空间由所有的线程共享。但是为了更好更快的为对象实例分配内存，往往会将堆空间划分出多个线程私有的分配缓冲区(Thread Local Allocation Buffer，**TLAB**)。
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200910134457116.png" alt="image-20200910134457116" style="zoom: 67%;" />
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200910141713815.png" alt="image-20200910141713815" style="zoom:67%;" />
...
> - 在JDK7之前，方法区采用永久代(Permanent Generation)的形式实现，这样GC也可以参与堆的垃圾回收，但是容易产生OOM问题
>
> - 在JDK8之后，采用元数据(Meta Space)来替换永久代
>
...
属于方法区的一部分，是线程共享的。其中的内容可以在编译器和运行期(String的intern()方法)生成。
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200907134819947.png" alt="image-20200907134819947" style="zoom: 50%;" />
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200907134954269.png" alt="image-20200907134954269" style="zoom:50%;" />
