...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200904210055167.png" alt="image-20200904210055167" style="zoom: 80%;" />
...
例如，编写一个面向接口的应用程序，可以等到**运行时**再指定其实际的实现类，用户可以通过Java预置的或自定义**类加载器**，让某个本地的应用程序在运行时从网络或其他地方上加载一个二进制流作为其程序代码的一部分（*引自*[[1]](#####[1]深入理解Java虚拟机(第三版)-周志明)）

### 7.2主动引用&被动引用

#### 7.2.1区别

主动引用和被动引用**主要区分**在是否**对类立即初始化**(在加载、验证、准备之后进行)，主动引用存在以下几种情况，除了下面的几种情况，全部是被动引用
...
引导类(启动类)加载器是由C++编写的，属于JVM一部分的加载器（也就意味着，在代码中获取此类加载器加载的类的加载器时为null）
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200924160330978.png" alt="image-20200924160330978" style="zoom: 67%;" />
...
<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200924163302693.png" alt="image-20200924163302693" style="zoom: 80%;" />

变化后的继承关系

<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200924163345084.png" alt="image-20200924163345084" style="zoom: 80%;" />

##### 3）双亲委派模型改动

<img src="C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20200924163238575.png" alt="image-20200924163238575" style="zoom: 67%;" />
